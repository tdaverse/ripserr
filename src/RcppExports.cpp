...
RcppExport SEXP _ripserr_ripser_cpp(SEXP input_pointsSEXP, SEXP dimSEXP, SEXP threshSEXP, SEXP formatSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_ripserr_ripser_cpp", (DL_FUNC) &_ripserr_ripser_cpp, 4},
    {NULL, NULL, 0}
};
