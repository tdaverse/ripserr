...
@fig-benchmark compares the runtimes of two versions of {ripserr} to compute degree-2 persistence on samples from 4 manifolds: the circle $\mathbb{S}^1$, the torus $\mathbb{T}^2$, the real projective plane $\mathbb{RP}^2$, and the orthogonal matrix group $O(3)$.
